...
export const SECTIONS = [
  ...
  { id: 'content', label: 'Site content', href: '/admin/content' },
  { id: 'orders', label: 'Orders', href: '/admin/orders' },
  { id: 'service_bookings', label: 'Service bookings', href: '/admin/service-bookings' },
  ...
  { id: 'quick_links', label: 'Quick links', href: '/admin/quick-links' },
  { id: 'redirects', label: 'Redirects', href: '/admin/uniredirect' },
  { id: 'brochures', label: 'Brochures', href: '/admin/brochures' },
  { id: 'locations', label: 'GMB locations', href: '/admin/locations' },
  { id: 'cities', label: 'States & cities', href: '/admin/cities' },
  ...
  { id: 'comments', label: 'Comments', href: '/admin/comments' },
  { id: 'reviews', label: 'Product reviews', href: '/admin/reviews' },
...
export const ROLES = [
  ...
  },
  {
    ...
    sections: ['dashboard', 'orders', 'products', 'categories', 'customers', 'enquiries', 'messages', 'brochures', 'coupons', 'locations'],
  ...
  {
    id: 'seo', label: 'SEO', description: 'Page content and search listings: products, categories, service pages, redirects, blogs and GMB locations.',
    sections: ['dashboard', 'home', 'content', 'products', 'categories', 'service_pages', 'quick_links', 'redirects', 'blogs', 'comments', 'locations', 'cities'],
    actions: ALL_ACTIONS,
  },
  {
...
export function cleanAccess({ role, sections, actions }) {
  ...
  return {
    role: known,
    // An owner always has every section — including ones added after their
    // access was saved, which a stored list would otherwise leave out.
    sections: known === 'owner' ? [...ALL_SECTIONS] : ALL_SECTIONS.filter((id) => (sections || []).includes(id)),
