...
// How many city pages per service family are prerendered. None by default: the
// national service pages (a family of one) are always built, and every city
// page renders on its first visit and then stays cached. All 22,195 URLs work;
// only the deploy is spared building them.
const PRERENDER_PER_FAMILY = Number(process.env.PRERENDER_PER_FAMILY) || 0;
