    ...
    <>
      <div className="border-b border-line bg-surface-muted">
        <div className="df-container py-6 md:py-8">
          ...
          {page.ratingLabel ? (
            <p className="mt-3.5 inline-flex items-center gap-2 rounded-lg border border-line bg-white px-3 py-1.5 text-[14px] text-ink-500">
          ...
          {page.promise?.length ? (
            <ul className="mt-6 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
              {page.promise.map((p) => (
                <li key={p} className="df-card flex items-center gap-2 px-3.5 py-2.5 text-[13.5px] text-ink-500">
            ...
            <section className="mt-12 border-t border-line pt-10">
              ...
              <ul className="grid gap-3 sm:grid-cols-2">
                {page.whyChoose.points.map((p, i) => (
                  <li key={i} className="df-card p-4">
