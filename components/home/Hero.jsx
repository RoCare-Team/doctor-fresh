      ...
      <div className="df-container relative pb-8 pt-6 sm:pb-10 lg:flex lg:min-h-[580px] lg:items-center lg:py-16">
        <div className="max-w-xl lg:max-w-lg">
          ...
          >
            ...
            <span className="block text-primary-500 lg:inline"> home, office &amp; industry</span>
          </h1>
          ...
          >
            ...
            >
              ...
              <span className="hidden sm:inline">Shop water purifiers</span>
            ...
            >
              <span className="sm:hidden">Free water test</span>
              <span className="hidden sm:inline">Book free water test</span>
            </Link>
          </div>
